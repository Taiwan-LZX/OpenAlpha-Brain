    ...
    while True:
        ...
        try:
            ...
            logger.info(
                ...
                session_id, summary.get("total_tracked", 0),
        ...
        try:
            ...
            if results:
                ...
                logger.info(
                    ...
                    session_id, len(_crossover_insights),
                )
                ...
                if _mut_results:
                    ...
                    for _mr in _mut_results:
                        ...
                        logger.info(
                            ...
                            session_id, _mr.weak_segment, _mr.mutation_type,
                ...
                if _exploration_proposals:
                    ...
                    logger.info(
                        ...
                        session_id, len(_exploration_proposals), len(_ls._crossover_exploration_proposals),
                    )
                ...
                if _weak_segment_alerts:
                    ...
                    logger.info(
                        ...
                        session_id, len(_weak_segment_alerts),
                    )
            _health.record_success()
        except TimeoutError:
            _health.record_failure("timeout")
