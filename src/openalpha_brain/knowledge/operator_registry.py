    ...
    def _load_builtin_operators(self):
        self.register(
            OperatorDef(
                ...
                description="时间序列均值",
                risk_level="medium",
                alternatives=["ts_decay_linear", "ts_sum", "ts_median"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=2,
                max_args=3,
                args_type=["field", "window", "decay"],
                requires_lookback=True,
                default_lookback=10,
                description="线性衰减加权 — 过审因子核心算子 ⭐",
                risk_level="low",
                alternatives=["ts_mean", "ts_sum"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                description="时间序列标准差",
                risk_level="medium",
                alternatives=["ts_av_diff", "ts_zscore"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                risk_level="low",
                alternatives=["ts_av_diff", "ts_rank"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=2,
                max_args=3,
                args_type=["field", "window", "constant"],
                requires_lookback=True,
                default_lookback=20,
                description="时间序列排名",
                risk_level="low",
                alternatives=["ts_quantile", "ts_zscore"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=2,
                max_args=2,
                args_type=["field", "days"],
                requires_lookback=True,
                default_lookback=1,
                description="时间延迟 — 获取 d 天前的值",
                risk_level="medium",
                alternatives=["ts_delta"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                description="时间序列求和",
                risk_level="medium",
                alternatives=["ts_mean", "ts_decay_linear"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=3,
                max_args=3,
                args_type=["field_x", "field_y", "window"],
                requires_lookback=True,
                default_lookback=20,
                description="时间序列相关性",
                risk_level="low",
                alternatives=["ts_covariance", "ts_regression"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                risk_level="high",
                alternatives=["ts_decay_linear", "ts_av_diff"],
        ...
        self.register(
            OperatorDef(
                ...
                risk_level="low",
                alternatives=["ts_zscore", "ts_decay_linear"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=2,
                max_args=3,
                args_type=["field", "window", "driver"],
                requires_lookback=True,
                default_lookback=60,
                description="时间序列分位数变换",
                risk_level="low",
                alternatives=["ts_rank", "ts_zscore"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=3,
                max_args=5,
                args_type=["y", "x", "window", "lag", "rettype"],
                requires_lookback=True,
                default_lookback=20,
                description="时间序列回归 — 提取 beta/alpha/residual",
                risk_level="low",
                alternatives=["ts_corr", "ts_covariance"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                risk_level="medium",
                alternatives=["ts_arg_min", "ts_rank"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                risk_level="medium",
                alternatives=["ts_arg_max", "ts_rank"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                description="时间序列偏度",
                risk_level="medium",
                alternatives=["ts_kurtosis", "ts_std_dev"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                description="时间序列峰度",
                risk_level="medium",
                alternatives=["ts_skewness", "ts_std_dev"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=3,
                max_args=3,
                args_type=["field_y", "field_x", "window"],
                requires_lookback=True,
                default_lookback=20,
                description="时间序列协方差",
                risk_level="medium",
                alternatives=["ts_corr", "ts_regression"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=2,
                max_args=3,
                args_type=["field", "lookback", "k"],
                requires_lookback=True,
                default_lookback=5,
                description="用最近有效值填充 NaN",
                risk_level="low",
                alternatives=["kth_element"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=3,
                max_args=4,
                args_type=["field", "window", "k", "ignore"],
                requires_lookback=True,
                default_lookback=5,
                description="获取第 K 个历史值",
                risk_level="low",
                alternatives=["ts_backfill", "ts_delay"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                risk_level="medium",
                alternatives=["ts_delay", "kth_element"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=1,
                max_args=2,
                args_type=["field", "rate"],
                requires_lookback=False,
                default_lookback=None,
                description="截面排名 — 归一化到 [0,1] ⭐",
                risk_level="low",
                alternatives=["zscore", "scale", "group_rank"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                risk_level="low",
                alternatives=["rank", "normalize", "group_zscore"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=1,
                max_args=4,
                args_type=["field", "scale", "longscale", "shortscale"],
                requires_lookback=False,
                default_lookback=None,
                description="缩放到目标仓位规模",
                risk_level="low",
                alternatives=["rank", "normalize"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                risk_level="low",
                alternatives=["normalize", "quantile"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=1,
                max_args=3,
                args_type=["field", "useStd", "limit"],
                requires_lookback=False,
                default_lookback=None,
                description="截面标准化 — 去均值/除标准差",
                risk_level="low",
                alternatives=["zscore", "winsorize"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=1,
                max_args=3,
                args_type=["field", "driver", "sigma"],
                requires_lookback=False,
                default_lookback=None,
                description="分位数变换 — 降低异常值影响",
                risk_level="low",
                alternatives=["rank", "winsorize"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=2,
                max_args=2,
                args_type=["field", "group"],
                requires_lookback=False,
                default_lookback=None,
                description="组内去均值 — 行业/板块中性 ⭐",
                risk_level="low",
                alternatives=["group_zscore", "group_mean"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                description="组内排名",
                risk_level="low",
                alternatives=["rank", "group_zscore"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                risk_level="low",
                alternatives=["group_neutralize", "zscore"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=2,
                max_args=3,
                args_type=["field", "weight", "group"],
                requires_lookback=False,
                default_lookback=None,
                description="组内均值（加权调和平均）",
                risk_level="low",
                alternatives=["group_neutralize"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=3,
                max_args=4,
                args_type=["field", "group", "window", "std"],
                requires_lookback=True,
                default_lookback=5,
                description="组内回填 NaN — 用 winsorized mean 填充",
                risk_level="low",
                alternatives=["ts_backfill"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=3,
                max_args=3,
                args_type=["value", "condition", "exit_condition"],
                requires_lookback=False,
                default_lookback=None,
        ...
        self.register(
            OperatorDef(
                ...
                description="幂运算 x ^ y",
                risk_level="medium",
                alternatives=["signed_power", "sqrt"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                description="倒数 1/x",
                risk_level="medium",
                alternatives=["divide(1, x)", "power(x, -1)"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=3,
                max_args=3,
                args_type=["condition", "true_value", "false_value"],
                requires_lookback=False,
                default_lookback=None,
                description="条件分支 if-else ⭐",
                risk_level="low",
                alternatives=["trade_when"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=1,
                max_args=1,
                args_type=["vector_field"],
                requires_lookback=False,
                default_lookback=None,
                description="向量求和",
                risk_level="low",
                alternatives=["vec_avg"],
            )
        )
        ...
        self.register(
            OperatorDef(
                ...
                min_args=2,
                max_args=5,
                args_type=["field", "range", "buckets", "skipBoth", "NaNGroup"],
                requires_lookback=False,
                default_lookback=None,
                description="分桶 — 将排名值离散化为组别",
                risk_level="low",
                alternatives=["group_neutralize", "group_rank"],
            )
        )
