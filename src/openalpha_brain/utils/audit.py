...
results.append(chk("sessions/ dir auto-created on startup",
    "mkdir" in _src("main.py", "cli") or "mkdir" in sm_src))
...
results.append(chk("ExperienceDistiller: experience_cards.json has cards", isinstance(_ec_data, list) and len(_ec_data) > 0))
