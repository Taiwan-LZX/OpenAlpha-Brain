...
> **相關連結：** 本庫同時支援新版 BrainAlpha Agent（M0-M4 架構）。新架構使用 660-cell 結構化探索網格，可將 Alpha101 表達式對應到對應的學術 Cell，實現更有方向的探索。詳見 [`BRAINALPHA_REPRODUCTION_PLAN.md`](BRAINALPHA_REPRODUCTION_PLAN.md)。
