...
> **注意：** 本文件描述的是原有的 `alpha_research_pipeline.py` 基線搜尋管線（Legacy）。BrainAlpha 實作使用了全新 M0-M4 架構（含 LLM M2/M4），詳見 [`BRAINALPHA_REPRODUCTION_PLAN.md`](BRAINALPHA_REPRODUCTION_PLAN.md)。
