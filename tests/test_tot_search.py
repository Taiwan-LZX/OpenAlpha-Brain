...
class TestToTNode:
    ...
    def test_node_state_enum_values(self):
        ...
        expected_states = ["expanding", "evaluated", "pruned", "survivor", "leaf"]
...
class TestToTConfig:
    ...
    def test_config_ratios_sum_to_one(self, default_config):
        ...
        total_ratio = default_config.llm_expand_ratio + default_config.mutation_ratio + default_config.crossover_ratio
